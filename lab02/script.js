...
function appendChar(char) {
	...
	toSolve += charToSolve
	document.querySelector('.screen').value += charToDisplay
}
...
function solve() {
	...
	document.querySelector('.screen').value = result // display it for the user
}
...
function deleteLastChar() {
	...
	if (checkForOperator_log10 == 'Math.log10') {
		...
		// if there is only one char both display result and toSolve
		cutFrom_toSolve = 1
		cutFrom_display = 1
	}
